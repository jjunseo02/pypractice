...
"""
아래 변수를 사용하여 각 주석에 해당하는 조건식 작성 후
결과 (T/F)를 *출력*하기
...
print(score > 60 and attendance < 70)
